...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-go,~/.vim/plugged/nerdtree,~/.vim/plugged/vim-multiple-cursors,~/.vim/plugged/molokai,~/.vim/plugged/vim-ruby,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after
set suffixes=.bak,~,.swp,.o,.info,.aux,.log,.dvi,.bbl,.blg,.brf,.cb,.ind,.idx,.ilg,.inx,.out,.toc
set virtualedit=onemore
let s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
let v:this_session=expand("<sfile>:p")
silent only
cd ~/learning/wgu/C950_DSAlgo2/ruby
...
badd +30 truck.rb
badd +1 package.rb
badd +1 WGUInputData.csv
badd +1 location.rb
badd +1 WGUDistanceNameData.csv
badd +1 graph.rb
badd +1 vertex.rb
badd +1 edge
badd +1 edge.rb
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 40 - ((12 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 55 - ((33 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
...
30
normal! 07|
tabedit WGUDistanceNameData.csv
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
