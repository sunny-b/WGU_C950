...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-go,~/.vim/plugged/nerdtree,~/.vim/plugged/vim-multiple-cursors,~/.vim/plugged/molokai,~/.vim/plugged/vim-ruby,~/.vim/plugged/indentpython.vim,~/.vim/plugged/YouCompleteMe,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after
...
silent only
cd ~/learning/wgu/C950_DSAlgo2/python
...
badd +0 vertex.py
badd +0 main.py
badd +0 hash_table.py
badd +0 location.py
badd +0 location_data.csv
argglobal
silent! argdel *
$argadd package.py
set stal=2
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 23 - ((16 * winheight(0) + 8) / 17)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
